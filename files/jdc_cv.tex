...
% Count entries in each publication category
\AtDataInput{%
  \ifkeyword{article}{%
    \csnumgdef{articlecount}{%
      \csuse{articlecount}+1}%
  }{}%
  \ifkeyword{review}{%
    \csnumgdef{reviewcount}{%
      \csuse{reviewcount}+1}%
  }{}%
  \ifkeyword{book}{%
    \csnumgdef{bookcount}{%
  ...
  \ifkeyword{abstract}{%
    \csnumgdef{abstractcount}{%
      \csuse{abstractcount}+1}%
  }{}%
  \ifkeyword{preprint}{%
    \csnumgdef{preprintcount}{%
      \csuse{preprintcount}+1}%
  }{}%
}

% Reverse the numbering within each publication category
\DeclareFieldFormat{labelnumber}{%
  \ifkeyword{article}
    {\number\numexpr\csuse{articlecount}+1-#1\relax}
    {\ifkeyword{review}
      {\number\numexpr\csuse{reviewcount}+1-#1\relax}
      {\ifkeyword{book}
        {\number\numexpr\csuse{bookcount}+1-#1\relax}
        {\ifkeyword{abstract}
          {\number\numexpr\csuse{abstractcount}+1-#1\relax}
          {\number\numexpr\csuse{preprintcount}+1-#1\relax}
        }
      }
    }
}
