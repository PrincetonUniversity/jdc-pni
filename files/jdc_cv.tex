...
\defbibenvironment{jdcounter}
  {\renewcommand{\blx@driver}[1]{}}
  {}
  {\csnumgdef{jdcsectioncount:\therefsection}{%
      \csuse{jdcsectioncount:\therefsection}+1}}

\makeatother

\DeclareFieldFormat{labelnumber}{%
  \number\numexpr
    \csuse{jdcsectioncount:\therefsection}+1-#1
  \relax
}
...
\begin{refsection}
    ...
    \csnumgdef{jdcsectioncount:\therefsection}{0}
    \printbibliography[
        heading=none,
        env=jdcounter,
        keyword=article
