...
\usepackage[backend=biber, sorting=ydnt, style=numeric, maxbibnames=99, maxcitenames=3, giveninits=true]{biblatex}
...
% Publication tags NEW

\newcommand{\JDCtag}[1]{%
  \textcolor{gray}{\textsf{\footnotesize [#1]}}%
}

\newcommand{\JDCPrintTags}{%
  \ifkeyword{article}{\JDCtag{ARTICLE}\space}{}%
  \ifkeyword{review}{\JDCtag{REVIEW}\space}{}%
  \ifkeyword{book}{\JDCtag{BOOK}\space}{}%
  \ifkeyword{abstract}{\JDCtag{ABSTRACT}\space}{}%
  \ifkeyword{preprint}{\JDCtag{PREPRINT}\space}{}%
  \ifkeyword{under-review}{\JDCtag{UNDER REVIEW}\space}{}%
  \ifkeyword{in-preparation}{\JDCtag{IN PREPARATION}\space}{}%
}
...
\begin{refsection}[jdc_master.bib]
    \nocite{*}
